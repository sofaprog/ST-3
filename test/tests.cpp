// Copyright 2024 Sofia Makoveeva
// This file contains unit tests for TimedDoor, Timer and DoorTimerAdapter
...
class TimedDoorTest : public ::testing::Test {
 protected:  // Отступ 1 пробел перед protected
  TimedDoor* door;
...
class MockTimerClient : public TimerClient {
 public:  // Отступ 1 пробел перед public
...
class TestableDoorTimerAdapter : public DoorTimerAdapter {
 private:  // Отступ 1 пробел перед private
  std::exception_ptr* storedException;

 public:  // Отступ 1 пробел перед public
  explicit TestableDoorTimerAdapter(TimedDoor& door,
...
// Тест 10: Интеграция - исключение выбрасывается
// если дверь открыта дольше таймаута
...
// Тест 11: Интеграция - исключение НЕ выбрасывается
// если дверь закрыта вовремя
